...
// TODO
// const greatAuthors = []
const greatAuthors = books.filter(collections => collections.sales > 1000000).map(collections => { return `${collections.author} adalah penulis buku ${collections.title} yang sangat hebat!`})
